...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
	...
	<a href="index.php?page=art_fs" class="nav-item nav-art_fs"><span class='icon-field'><i class="fa fa-dollar-sign"></i></span> Sale</a>
				...
				<a href="index.php?page=ArtCategory" class="nav-item nav-artcategory"><span class='icon-field'><i class="fa fa-users"></i></span> Art Category</a>
<a href="index.php?page=Product" class="nav-item nav-add arts"><span class='icon-field'><i class="fa fa-paint-brush"></i></span>Add Arts</a>				
