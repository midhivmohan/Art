...
<input type="text" class="form-control datetimepicker" name="event_datetime"  value="<?php echo isset($event_datetime) ?
 date("Y-m-d H:i",strtotime($event_datetime)) :'' ?>" required autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-5">
...
<input type="content" class="form-control" name="art_description" value="<?php echo isset($content) ?
 html_entity_decode($content) : '' ?>"pattern="^[A-Z a-z]+$" title="Use alphabets Only" required autocomplete="off">
					...
					<div class="row form-group">
						<input type="file" id="chooseFile" multiple="multiple" onchange="displayIMG(this)"
						accept="image/x-png,image/gif,image/jpeg" style="display: none"required>
