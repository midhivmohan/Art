...
<div class="container-fluid">
	...
	<input type="text" class="form-control" name="art_title"  value="<?php echo isset($art_title) ? $art_title :'' ?>"
...
<input type="text" class="form-control" name="art_description" value="<?php echo isset($art_description) ?
 html_entity_decode($art_description) : '' ?>"pattern="^[A-Z a-z]+$" title="Use alphabets Only" required autocomplete="off">
	...
	<input type="file" id="chooseFile" multiple="multiple" onchange="displayIMG(this)" accept="image/x-png,image/gif,image/jpeg" 
